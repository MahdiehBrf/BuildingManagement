...
urlpatterns = [
    ...
    url(r'^(?P<reserve_id>\d{4}-\d{2}-\d{2}\s\d{2}:\d{2}:\d{2}.[0-9]*\W\d{2}:\d{2})/reject_reserve/$',
        views.reject_reserve,
        name='reject_reserve'),
    url(r'^(?P<reserve_id>\d{4}-\d{2}-\d{2}\s\d{2}:\d{2}:\d{2}.[0-9]*\W\d{2}:\d{2})/accept_reserve/$',
        views.accept_reserve, name='accept_reserve'),
